...
def main():
	fname = []
	path = './' + str(raw_input("Enter the name of the directory (English files): "))
	...
	fout.close()
	print("\nThe aligned files were combined into a text file named \'output_english\'\n")
